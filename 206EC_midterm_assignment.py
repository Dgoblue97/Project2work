...
# On the exam I originially thought the for loop was entering in input list thus the answer would have returned [1,2] and [1,2] again.
# Now i see the for loop iterates over the input and when it hits the return statement the function ceases. This leaves us with the function returning [1,2]
print("\n*******\n")
...
## Put your answer to the question here:
def compare_rank(self, x):
    winning_compairison = True
    if x > self.rank_num:
        return winning_compairison
    else:
        winning_compairison = False
        return winning_compairison    

## Put your comment explanations/reflections here:

# Oriiginally had read the question wrong and checked for the wrong comparison. Now i know which boolean value to return for the correct comparison of the instance variable rank_num.
...
# originially because of the indexing being done I thought it could also be a list or a tuple along with a string.
# Now I understand that because of the slicing in the first if statment can only be done in a string and would not make sense with any other type of object.
print("\n*******\n")
...
# During the exam i got misread the question and thought purple[3] was referring to a integer and blue[0] was referring to a string
# because i misread this i know an integer and a string could not be added together so i wrote down an error
# Now i see stuff['purple'][3] is referring to 'SI' and stuff["blue"][0] is referring to 'C' which gives us the answer 'SIC'
print("\n*******\n")
...
# 15 Number 2 Explnation

# On the exam i thought B D & E were all correct, but now I see B is in correct becasue the first parameter is required
print("\n*******\n")
